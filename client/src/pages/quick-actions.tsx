...
export default function QuickActions() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-6xl">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Take action to help your community and manage your needs</p>
          </div>
        </div>
      </div>
      ...
      {user && (
        <Card className="mb-8 bg-gradient-to-r from-coral/5 to-coral/10 border-coral/20">

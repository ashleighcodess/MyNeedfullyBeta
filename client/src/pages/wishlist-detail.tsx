                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-between p-2 bg-white rounded-lg border">
                              ...
                              <button 
                                ...
                                disabled={item.isFulfilled || (itemPricing[item.id]?.pricing?.target?.available === false)}
                                className={`py-2 px-4 rounded text-sm font-medium transition-colors ${
                                  item.isFulfilled || (itemPricing[item.id]?.pricing?.target?.available === false)
                                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed' 
                                    : 'bg-coral text-white hover:bg-coral/90'
                                }`}
                              >
                            ...
                            <div className="flex items-center justify-between p-2 bg-white rounded-lg border">
                              ...
                              <button 
                                ...
                                disabled={item.isFulfilled || (itemPricing[item.id]?.pricing?.walmart?.available === false)}
                                className={`py-2 px-4 rounded text-sm font-medium transition-colors ${
                                  item.isFulfilled || (itemPricing[item.id]?.pricing?.walmart?.available === false)
                                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed' 
                                    : 'bg-coral text-white hover:bg-coral/90'
                                }`}
                              >
